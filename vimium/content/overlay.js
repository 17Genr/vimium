...
var Vimium = {
	...
	// <input id="element_msg-checkbox-48531" class="message-checkbox flag_hush-content-loader-remember" type="checkbox">
	// use a blacklist instead of a whitelist because new form controls are still being implemented for html5
	var noFocus = ["radio", "checkbox", "button", "submit"];
	if (nodeName == "input" && noFocus.indexOf(target.type) > 0)
	    return false;
	...
	if(!active && !editable && (isCheckbox(e) || e.target.innerHTML) && !e.ctrlKey) {
